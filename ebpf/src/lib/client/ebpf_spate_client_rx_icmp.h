...
#ifndef __EBPF_SPATE_CLIENT_RX_ICMP_H__
#define __EBPF_SPATE_CLIENT_RX_ICMP_H__


#include "ebpf_spate_client_dep.h"

static __inline int __ebpf_spate_client_rx_icmp(icmp_hdr_t *icmp, uint16_t len, ipv4_hdr_t *iph,
        spate_ebpf_client_config_t *cfg)
{
    ...
    char            fmt4[] = "spate client replay icmp";
...
#endif /* __EBPF_SPATE_CLIENT_RX_ICMP_H__ */
